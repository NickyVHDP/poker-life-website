const books = [
  ...
  { slug: 'poker-life-culture', title: 'Poker Life: The Complete Guide to Poker Culture', category: 'mindset', blurb: 'The poker world, from the inside out.', price: '$12.99', stripeUrl: 'https://buy.stripe.com/4gMaEXacC2gg3a2b5l2Nq0a', description: 'A look at the people, routines, language, and unwritten rules that shape the poker world. It is written for readers who want to understand the culture around the cards as well as the game itself.' },
  { slug: 'only-poker-book-youll-ever-need', title: 'The Only Poker Book You’ll Ever Need', category: 'strategy', blurb: 'One strong reference.', price: '$9.99', stripeUrl: 'https://buy.stripe.com/28E5kDdoO8EE7qi1uL2Nq07', description: 'A broad, practical reference for players who want the core ideas in one place. It brings together strategy, table awareness, basic math, and mindset into an approachable guide for ongoing study.' },
...
function amazonSearchUrl(book) {
  return `https://www.amazon.com/s?k=${encodeURIComponent(`${book.title} Larry McCracken`)}`;
}
...
if (directBenefitsPanel) {
  ...
  referenceArtwork.src = 'assets/direct-benefits-reference.jpg?v=2';
