const books = [
  ...
  { slug: 'poker-life-culture', title: 'Poker Life: The Complete Guide to Poker Culture', category: 'mindset', blurb: 'The poker world, from the inside out.', price: '$9.99', stripeUrl: 'https://buy.stripe.com/4gMaEXacC2gg3a2b5l2Nq0a', description: 'A look at the people, routines, language, and unwritten rules that shape the poker world. It is written for readers who want to understand the culture around the cards as well as the game itself.' },
